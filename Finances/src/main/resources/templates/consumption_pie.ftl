...
<table cellpadding="10" bgcolor="#b0e0e6" align="center" width="100%" style="background-color: #3e94ec">
    <tr>
        <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                      href="http://localhost:8081/consumption_pie?sort=0" </a><p
                id="demo"></p></th>
        <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                      href="http://localhost:8081/consumption_pie?sort=-1" </a><p
                id="demo1"></p></th>
        <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                      href="http://localhost:8081/consumption_pie?sort=-2"</a><p
                id="demo2"></p></th>
        <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                      href="http://localhost:8081/consumption_pie?sort=-3"</a><p
                id="demo3"></p></th>
        <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                      href="http://localhost:8081/consumption_pie?sort=-4"</a><p
                id="demo4"></p></th>
        <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                      href="http://localhost:8081/consumption_pie?sort=-5"</a><p
                id="demo5"></p></th>
    </tr>
</table>
<br>
