...
<div class="finance_category" align="center">
    ...
    <form action="/finances/add" method="post">
        ...
        <table cellpadding="10" bgcolor="#b0e0e6" align="center" width="100%">
            <tr>
                <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                              href="http://localhost:8081/category_income_sort?sort=DAY"
                                                              onclick="f('DAY')" </a>
                    День
                </th>
                <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                              href="http://localhost:8081/category_income_sort?sort=WEEK"
                                                              onclick="f('WEEK')"</a>
                    Неделя
                </th>
                <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                              href="http://localhost:8081/category_income_sort?sort=MONTH"
                                                              onclick="f('MONTH')"</a>
                    Месяц
                </th>
                <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                              href="http://localhost:8081/category_income_sort?sort=YEAR"
                                                              onclick="f('YEAR')"</a>
                    Год
                </th>
                <th height="40" width="110" align="center"><a style="color: #FFFFFF;text-decoration: none"
                                                              onclick="getSort('IncomeReport')" </a>
                    Отчет
                </th>
            </tr>
        </table>
